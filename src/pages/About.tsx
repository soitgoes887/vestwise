  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">About Vestwise</h1>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">RSU Management</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">ESPP Projections</h3>
              <p className="text-gray-700">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">UK Tax Calculations</h3>
              <p className="text-gray-700">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <h2 className="text-2xl font-semibold text-indigo-600 mb-4">Key Assumptions</h2>
